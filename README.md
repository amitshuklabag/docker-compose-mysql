...
<a href="https://dash.elest.io/deploy?source=cicd&social=dockerCompose&url=https://github.com/amitshuklabag/docker-compose-mysql"><img src="deploy-on-elestio.png" alt="Deploy on Elest.io" width="180px" /></a>
...
Click [here](https://dash.elest.io/deploy?source=cicd){:target="_blank"} to directly go to the CI/CD
